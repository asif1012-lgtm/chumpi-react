...
export default function Validation() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden md:flex flex-col h-screen border-r" style={{ width: "320px" }}>
        <div className="p-4">
      ...
      <div className="flex-1 flex flex-col">
        {/* Navigation Bar */}
        <nav className="sticky top-0 z-10 flex items-center justify-between p-3 sm:p-4 border-b">
        ...
        {/* Main Content */}
        <div className="flex-1 px-4 py-6 sm:py-8 overflow-y-auto bg-gradient-to-br from-[#0180FA]/10 via-[#f0f2f5] to-[#0180FA]/5">
        ...
        <footer className="text-center p-3 sm:p-4 border-t">
          <h1 className="text-xl sm:text-2xl font-bold text-[#1c1e21]">Meta © 2025</h1>
        </footer>
      </div>
